  ...
  [
    {
      ...
      children: [
        ...
        { path: '/zh/sports/world-cup', element: <HomePage /> },
        { path: '/zh/pop-culture/art', element: <HomePage /> },
        { path: '/zh/breaking', element: <HomePage /> },
        { path: '/zh/politics', element: <HomePage /> },
        { path: '/zh/crypto', element: <HomePage /> },
        { path: '/zh/esports', element: <HomePage /> },
        { path: '/zh/iran', element: <HomePage /> },
        { path: '/zh/finance', element: <HomePage /> },
        { path: '/zh/geopolitics', element: <HomePage /> },
        { path: '/zh/tech', element: <HomePage /> },
        { path: '/zh/pop-culture', element: <HomePage /> },
        { path: '/zh/economy', element: <HomePage /> },
        { path: '/zh/weather', element: <HomePage /> },
        { path: '/zh/mentions', element: <HomePage /> },
        { path: '/zh/elections', element: <HomePage /> },
